            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <form class="text-left needs-validation" action="" method="POST" novalidate id="checklogidetails">
                            <div class="form">
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    ...
                                    <div id="incorrect_id" class="invalid-feedback">
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <div class="field-wrapper">
                                        <button type="submit" class="btn btn-primary submit-fn mt-2" value="">Log In</button>
                                    </div>
                                </div>
...
<!--                                 <div class="social">
                                ...
                                <p class="signup-link">Not registered ? <a href="{{ url('/user') }}">Create an account</a></p>
...
<script type="text/javascript">
       $('#checklogidetails').on('submit', function(e) {
       e.preventDefault(); 
       var email = $('#email').val();
       ...
       $.ajax({
            ...
            success: function(res) {
                if(res.msg==false){
                $('#incorrect_id').show();//or $("#hidden").show();
                }else{
                    $('#incorrect_id').hide();
